...
class CustomNavigationController: UINavigationController, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let edgeSwipeGR = UIScreenEdgePanGestureRecognizer(target: self, action: #selector(handleScreenGesture))
    ...
    @objc func handleScreenGesture(recognizer: UIScreenEdgePanGestureRecognizer) {
